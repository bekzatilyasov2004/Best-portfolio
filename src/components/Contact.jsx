  ...
  return (
    <Box w="100%" p={5} display="flex" justifyContent={'space-around'} flexDir={'column'} alignItems="center">
      ...
      <Box
        ...
        color="white"
      >
        <Box p={{ base: '0', md: '10' }} mb={{ base: '70px', md: '0px' }} borderRadius="md" w="100%" maxW="600px">
          <Box textAlign={{ base: 'center', md: 'start' }} mt={{ base: '20px', md: '0px' }}>
            <Slide direction="down" duration={300}>
              <Text fontSize={{ base: '25px', md: '30px' }} mb={10}>
                Contact me
              </Text>
            </Slide>
          </Box>
          <form onSubmit={handleSubmit}>
            <Fade direction="left" cascade duration={300}>
              ...
              <Button type="submit" variant="solid" colorScheme="teal" width="full" size="lg">
                Submit
              </Button>
            </Fade>
          </form>
